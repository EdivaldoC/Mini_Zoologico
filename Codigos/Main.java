...
public class Main {
    ...
    public static void inserir(ArrayList<Animal> listaAnimais, Scanner sc) {
        ...
        System.out.println("Digite o peso da animal");
        ...
        switch (escolha) {
            ...
            case "4":
                ...
                System.out.println("Seu lobo eh alpha [true/false] ");
            ...
            default:
                System.out.println("Deu erro otario ");
                break;
    ...
    public static void excluir(ArrayList<Animal> listaAnimais, Scanner sc) {
        System.out.println("Qual o id do animal que deseja ser removido?");
        int id = sc.nextInt();
        ...
        for (int i = 0; i < listaAnimais.size(); i++) { 
            if (listaAnimais.get(i).getId() == id) {
                encontrado = true;
                System.out.println("Essas são as informações do animal que será excluído:");
